                                ...
                                <form onSubmit={handleCreateDocument}>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        >
                                            ...
                                            <option value="SOCIAL_SERVICE_CONTRACT">Socialinių paslaugų sutartys</option>
                                            <option value="REPORT">Ataskaitos</option>
                                            <option value="ASSISTANCE_PLAN">Pagalbos planai</option>
