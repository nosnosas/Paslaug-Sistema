...
import "./Home.css"; // Add a custom stylesheet for the homepage styling.
    ...
    return (
        <div>
                    ...
                    <div className="p-4 bg-primary text-white rounded shadow">
                        ...
                        <p>
                            ...
                            <img
                                ...
                                style={{
                                    maxWidth: "50px", /* Matches your preferred width */
                                    borderRadius: "5px",
                                    marginRight: "10px", /* Space between flag and text */
                                    verticalAlign: "middle", /* Aligns the flag with the text */
                                }}
                            />
            ...
            <div className="container my-5">
                ...
                <form className="p-4 rounded shadow-lg" style={{ background: "#f9f9f9" }}>
                    <div className="row">
            ...
            {/* Rekvizitai Section */}
            <div className="rekvizitai container text-center my-5 p-4 rounded shadow-sm" style={{ background: "#f9f9f9" }}>
                <h4>Rekvizitai</h4>
                <p className="mb-2">
                    <strong>Vilniaus miesto socialinių paslaugų centras</strong>
                </p>
                <p>
                    Sausio 13-osios g. 10, 04347 Vilnius<br />
                    Tel. <a href="tel:+37052133663" className="text-decoration-none">+370 5 213 3663</a><br />
                    <a href="mailto:info@spcentras.lt" className="text-decoration-none">info@spcentras.lt</a>
                </p>
                <hr />
                <p className="mb-0">
                    <strong>Darbo laikas:</strong> I - IV 7.30 - 16.30, V 7.30 - 15.15<br />
                    <em>Pietų pertrauka:</em> 11.30 - 12.15<br />
                    Kodas: 190997565
                </p>
            </div>
            {/* Footer */}
            <footer className="footer bg-dark text-white py-4">
                <div className="container text-center">
                    <p className="mb-1">
                        Vilniaus miesto socialinių paslaugų centras &copy; {new Date().getFullYear()}
                    </p>
                    <p className="mb-0">
