...
export default function AdministracineInformacija() {
    return (
        <div className="container my-5">
            <h1 className="text-center text-primary mb-4">Administracinė informacija</h1>
            <div className="row">
                {/* Section 1 */}
                <div className="col-md-6">
                    <h5 className="text-secondary">Teisės aktai ir kiti dokumentai</h5>
                    <p>
                        Čia rasite aktualią informaciją apie teisės aktus ir kitus dokumentus,
                        kurie reglamentuoja mūsų įstaigos veiklą. Dokumentai yra nuolat
                        atnaujinami pagal teisės aktų reikalavimus.
                    </p>
                    <ul>
                        <li>
                            <a
                ...
                <div className="col-md-6">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            Vilnius, Socialinės paslaugos gatvė 10, LT-12345
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="my-5">
                ...
                <p>
                    Informacija apie viešuosius pirkimus pateikiama pagal galiojančių teisės
                    aktų numatytas formas.
                </p>
                <p>
                    <a
